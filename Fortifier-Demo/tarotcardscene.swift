...
class tarotcardscene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        card1.position = CGPoint(x: 200, y: 200)
        addChild(card1)
